...
#Number of datasets
M=10
j=50  # will consider datasets c(1 : M)+j in sim_dat created in the data_for_sim_model1_MAR_4_groups.R code
...
# getDoParWorkers()
# n = M*3
cl <- makeCluster( n ) # change to makeCluster( n ) to use n processes
...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.MAR.res51_60 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.MAR.res51_60, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.MAR.res51_60.RData")
