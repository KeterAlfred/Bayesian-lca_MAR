...
#Number of datasets
M=10
j=30  # will consider datasets c(1 : M)+j in sim_dat created in the data_for_sim_model1_MAR_4_groups.R code
...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.MAR.res31_40 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.MAR.res31_40, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.MAR.res31_40.RData")
